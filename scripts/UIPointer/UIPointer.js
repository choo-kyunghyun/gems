// UIPointer — frame-latched pointer state for the whole UI. Singleton, not a UIComponent.
//
...
// CLAUDE.md). poll() reads each edge ONCE into a field; widgets read those fields, which

 ...
 * reachable from an id-keyed store without walking instances (testData perf.layout).
 ...
 * variable costs 3-4.5x a column access — testRuntime perf.access; TODO the rule loosens when a

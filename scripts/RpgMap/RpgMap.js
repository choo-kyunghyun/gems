...
globalThis.RpgMap = {
  ...
  build(scene, mapId, entryId, carry = null, travelers = []) {
    ...
    // 9. Renderer. ENTITIES use the greenfield 32px sprite set (RenderEntity over Visual — the
    //    spr_hero/spr_bandit/... art generated by tools/pixel-art-kit/common/entity_sprites.py).

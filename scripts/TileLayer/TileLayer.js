...
globalThis.TileLayer = class TileLayer {
  /** @param {number} width @param {number} height @param {{ emptyCost?: number }} [opt] */
  ...
  /** @param {{width:number,height:number}} data @param {Object} [opt] @returns {TileLayer} */
  ...
  /** @param {number} x @param {number} y @returns {NavData} */
  getNavData(x, y) {

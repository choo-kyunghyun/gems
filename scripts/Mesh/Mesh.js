 ...
 * @property {GMSprite} [topSprite]   sprite stretched over the top face (absent = flat fill)
 * @property {GMSprite} [frontSprite] sprite stretched over the front face (absent = flat fill)

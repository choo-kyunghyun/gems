...
- **The lobby's category sort shuffles ties**: `sceneLobby` sorts registry entries with a difference comparator and no tie-break — under #15593's actively-unstable sort, same-category entries reorder arbitrarily, defeating the "stable display list" the comment promises. Tie-break on registration index with the sign idiom.
